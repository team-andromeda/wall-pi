    ...
    if (dayBookings.value[t].location.uniqueId !== 'FILTER') {
      ...
      switch (startTime) {
        ...
        case '06:30':
          ...
          document.getElementById('SixT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = -1;
          break;
        case '07:00':
          document.getElementById('se').innerHTML = subject;
          document.getElementById('se').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 0;
          break;
        case '07:30':
        ...
        case '08:00':
          ...
          document.getElementById('ei').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 2;
          break;
        case '08:30':
          document.getElementById('eiT').innerHTML = subject;
          document.getElementById('eiT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 3;
          break;
        case '09:00':
          document.getElementById('ni').innerHTML = subject;
          document.getElementById('ni').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 4;
          break;
        case '09:30':
          document.getElementById('niT').innerHTML = subject;
          document.getElementById('niT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 5;
          break;
        case '10:00':
        ...
        case '10:30':
          ...
          document.getElementById('teT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 7;
          break;
        case '11:00':
        ...
        case '11:30':
          document.getElementById('el').innerHTML = subject;
          document.getElementById('elT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 9;
          break;
        case '12:00':
          document.getElementById('tw').innerHTML = subject;
          document.getElementById('tw').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 10;
          break;
        case '12:30':
          document.getElementById('twT').innerHTML = subject;
          document.getElementById('twT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 11;
          break;
        case '13:00':
        ...
        case '13:30':
          ...
          document.getElementById('onT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 13;
          break;
        case '14:00':
        ...
        case '14:30':
          ...
          document.getElementById('twoT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 15;
          break;
        case '15:00':
          document.getElementById('th').innerHTML = subject;
          document.getElementById('th').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 16;
          break;
        case '15:30':
          ...
          document.getElementById('thT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 17;
          break;
        case '16:00':
          document.getElementById('fo').innerHTML = subject;
          document.getElementById('fo').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 18;
          break;
        case '16:30':
          document.getElementById('foT').innerHTML = subject;
          document.getElementById('foT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 19;
          break;
        case '17:00':
          document.getElementById('fi').innerHTML = subject;
          document.getElementById('fi').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 20;
          break;
        case '17:30':
        ...
        case '18:30':
          ...
          document.getElementById('siT').style.backgroundColor =
            'rgb(100, 0, 0)';
          startValue = 21;
          break;
      }
